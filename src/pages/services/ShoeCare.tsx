          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-12">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    Thorough cleaning for all shoe materials and types
                  </p>
                </CardContent>
              </Card>
              <Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <CheckCircle2 className="w-12 h-12 text-secondary mb-4" />
                  <h3 className="text-xl font-semibold mb-2">Polish & Shine</h3>
                  <p className="text-muted-foreground">
                    Professional polishing for a mirror-like finish
                  </p>
                </CardContent>
              </Card>
              <Card>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                We collect your shoes from your doorstep
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-secondary text-white rounded-full flex items-center justify-center mx-auto mb-4">
