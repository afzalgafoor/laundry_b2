...
const Pricing = () => {
  ...
  const additionalServices = [
    { service: 'Express Service (Same Day)', price: '+50%', description: 'Rush processing for urgent needs' },
    { service: 'Starch Service', price: '+$1.00', description: 'Light, medium, or heavy starch' },
    { service: 'Garment Repairs', price: 'From $5.99', description: 'Basic alterations and repairs' },
    { service: 'Eco-Friendly Cleaning', price: '+$2.00', description: 'Biodegradable detergents' },
  ];
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Choose the plan that works best for you, or pay as you go.
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricingPlans.map((plan, index) => (
              <Card key={index} className={`relative hover:shadow-lg transition-all duration-300 hover:-translate-y-1 ${plan.popular ? 'border-secondary scale-105' : ''}`}>
                {plan.popular && (
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Prefer to pay as you go? Here's our transparent pricing for individual services.
            </p>
          </div>
            ...
            {[
              {
                ...
                answer: "No hidden fees ever. Our pricing is completely transparent. The only additional charges would be for optional services that you specifically request."
              },
              {
                question: "What if I go over my monthly limit?",
                answer: "Any overage is charged at our standard pay-per-use rates. We'll always notify you before processing items that would exceed your plan limits."
              },
              {
                question: "Can I cancel my monthly plan anytime?",
                answer: "Yes, you can cancel your monthly plan at any time with 30 days notice. No cancellation fees or penalties."
              },
              {
                question: "Do you offer discounts for new customers?",
                answer: "Yes! New customers get 20% off their first order. We also offer referral bonuses and occasional seasonal promotions."
              }
            ].map((faq, index) => (
              <Card key={index}>
                <CardContent className="p-6">
