...
const Services = () => {
  const featuredServices = [
    ...
    },
    {
      ...
      description:
        "Professional steam pressing for crisp, wrinkle-free clothes",
  ...
  const specialties = [
    {
      ...
      description:
        "Large item cleaning for comforters, quilts, and bedding sets",
    },
    {
      icon: ShirtIcon,
    ...
    },
    {
      ...
      title: "Leather & Suede",
      description:
        "Expert cleaning for leather jackets, suede items, and accessories",
    },
  ];
      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate-fade-in">
            ...
            all your garment care needs with professional quality and
            convenience.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "We clean your items using the best equipment and techniques",
              },
              {
                step: "4",
                title: "Delivery",
