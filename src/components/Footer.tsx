...
const Footer = () => {
  ...
  const footerLinks = {
    services: [
      ...
      { name: "Curtains & Carpet Cleaning", path: "/services/curtains-carpet" },
    ],
    company: [
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 py-16">
          ...
          <div className="md:col-span-1 col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/share/19fow49jgC/?mibextid=wwXIfr"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/blue.basketdxbgmailcom?igsh=MTNmdDFjdzQ1NWZ3cg=="
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-secondary transition-colors duration-200"
